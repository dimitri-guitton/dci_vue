        ...
        <div class="card-body">
            ...
            >
                ...
                >
                    ...
                    <!--begin::Step 3-->
                    <div data-kt-stepper-element="content">
                        <FileCpvStep3 :file-data="fileData" :lists="lists"></FileCpvStep3>
                    </div>
                    <!--end::Step 3-->

                    <!--begin::Step 4-->
                    <div data-kt-stepper-element="content">
                        <FileCpvStep4 :blank-options="blankOptions"
                                      :file-data="fileData"
                                      ...
                                      @generateQuotation="onGenerateQuotation"></FileCpvStep4>
                    </div>
                    <!--end::Step 4-->

                    <!--begin::Step 5-->
                    <div data-kt-stepper-element="content">
                        <FileCpvStep5 :file-data="fileData"
                                      :lists="lists"
                                      @generateWorksheet="onGenerateWorksheet"></FileCpvStep5>
                    </div>
                    <!--end::Step 5-->
...
export default defineComponent( {
                                    ...
                                    setup() {
                                        ...
                                        const fileData            = ref<CpvFile>( getCurrentCpvFileData() );
                                        ...
                                        const formData            = ref<CpvFileStep>( {
                                                                                          ...initFormDataStep1And2(
                                                                                              fileData.value.assents,
                                                                                              fileData.value.beneficiary ),
                                                                                          ...initCpvFormDataStep3(
                                                                                              fileData.value ),
                                                                                          ...initCpvFormDataStep4(
                                                                                              fileData.value ),
                                                                                          ...initCpvFormDataStep5(
                                        ...
                                        const handleStep = handleSubmit( async ( values ) => {
                                            ...
                                            if ( currentStepIndex.value === 0 ) {
                                                ...
                                                fileData.value = ( await validateStepTwo( formData.value ) as CpvFile );
                                            } else if ( currentStepIndex.value === 2 ) {
                                                fileData.value          = await validateCpvStep3( formData.value );
                                                forceRefreshStep4.value = !forceRefreshStep4.value;
                                            } else if ( currentStepIndex.value === 3 ) {
                                                await validateCpvStep4( formData.value, price );
                                            }
