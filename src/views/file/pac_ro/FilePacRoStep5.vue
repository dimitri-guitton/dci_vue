...
import { pacRoWorksheetBuilder } from '@/services/file/wizzard/pac_ro/step5Service';

export default defineComponent( {
                                  name:       'file-pac-ro-step-5',
                                  components: {
                                    Step5Form,
                                  },
                                  props:      {
                                    lists: Object as () => RoList,
                                  },
                                  ...
                                  setup( props, ctx ) {
                                    ...
                                    return {
                                      worksheetBuilder: pacRoWorksheetBuilder(),
                                      generateWorksheet,
                                    };
                                  },
                                } );
