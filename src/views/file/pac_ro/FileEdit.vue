    ...
    <div class="card-body">
      ...
      >
        ...
        >
          ...
          <!--begin::Step 4-->
          <div data-kt-stepper-element="content">
            <FilePacRoStep4 @generateQuotation="onGenerateQuotation"
                            ...
                            :file-data="fileData"
                            :products="products"></FilePacRoStep4>
          </div>
          <!--end::Step 4-->

          <!--begin::Step 5-->
          <div data-kt-stepper-element="content">
            <FilePacRoStep5 @generateWorksheet="onGenerateWorksheet" :lists="lists"></FilePacRoStep5>
          </div>
          <!--end::Step 5-->
