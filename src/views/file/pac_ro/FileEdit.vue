        ...
        <div class="card-body">
            ...
            >
                ...
                >
                    ...
                    <!--begin::Step 4-->
                    <div data-kt-stepper-element="content">
                        <FilePacRoStep4 :blank-options="blankOptions"
                                        :file-data="fileData"
                                        ...
                                        @generateQuotation="onGenerateQuotation"></FilePacRoStep4>
                    </div>
                    <!--end::Step 4-->

                    <!--begin::Step 5-->
                    <div data-kt-stepper-element="content">
                        <FilePacRoStep5 :lists="lists" @generateWorksheet="onGenerateWorksheet"></FilePacRoStep5>
                    </div>
                    <!--end::Step 5-->
...
import { getCurrentRoFileData, resetCurrentFileData } from '@/services/data/dataService';
...
import FilePacRoStep3 from '@/views/file/pac_ro/FilePacRoStep3.vue';
...
export default defineComponent( {
                                    ...
                                    setup() {
                                        ...
                                        const {
                                                  resetForm,
                                                  handleSubmit,
                                              }               = useForm<Step1 | Step2 | PacRoStep3 | BaseStep4 | PacRoStep5>(
                                            {
                                        ...
                                        const handleStep = handleSubmit( async ( values ) => {
                                            ...
                                            if ( currentStepIndex.value === 0 ) {
                                                ...
                                                await validatePacRoStep4( formData.value, price );
                                            }
                                        ...
                                        const onGenerateQuotation = handleSubmit( async ( values ) => {
                                            const newFileData     = await validatePacRoStep4( ( values as PacRoFileStep ),
                                                                                              price );
                                            // Loader
