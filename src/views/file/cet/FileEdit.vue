        ...
        <div class="card-body">
            ...
            >
                ...
                >
                    ...
                    <!--begin::Step 4-->
                    <div data-kt-stepper-element="content">
                        <FileCetStep4 :blank-options="blankOptions"
                                      :file-data="fileData"
                                      ...
                                      @generateQuotation="onGenerateQuotation"></FileCetStep4>
                    </div>
                    <!--end::Step 4-->

                    <!--begin::Step 5-->
                    <div data-kt-stepper-element="content">
                        <FileCetStep5 :lists="lists" @generateWorksheet="onGenerateWorksheet"></FileCetStep5>
                    </div>
                    <!--end::Step 5-->
...
export default defineComponent( {
                                    ...
                                    setup() {
                                        ...
                                        const formData            = ref<CetFileStep>( {
                                                                                          ...
                                                                                          ...initCetFormDataStep3(
                                                                                              fileData.value ),
                                                                                          ...initCetFormDataStep4(
                                                                                              fileData.value ),
                                                                                          ...initCetFormDataStep5(
