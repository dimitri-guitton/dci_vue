<template>
  <div class="w-100">
    ...
    <div class="row mb-15">
      ...
      <div class="col-md-4 fv-row">
        ...
        <Field
            ...
            class="form-control"
        >
          <item-list :lists="lists.tensionDisponibleList"></item-list>
        </Field>
        <ErrorMessage
            name="housingAvailableVoltage"
            class="fv-plugins-message-container invalid-feedback"
    ...
    <div class="row mb-15">
      <div class="col-md-4 fv-row">
        <label class="form-label mb-3">Superficie (<var>m<sup>2</sup></var>)</label>
        <Field
            type="number"
            class="form-control"
            name="area"
...
export default defineComponent( {
                                  ...
                                  setup( props ) {
                                    console.log( '%c LIST', 'background: #fdd835; color: #000000' );
                                    console.log( '%c LIST', 'background: #fdd835; color: #000000' );
                                    console.log( '%c LIST', 'background: #fdd835; color: #000000' );
                                    console.log( '%c LIST', 'background: #fdd835; color: #000000' );
                                    console.log( '%c LIST', 'background: #fdd835; color: #000000' );
