        ...
        <div class="card-body">
            ...
            >
                ...
                >
                    ...
                    <!--begin::Step 4-->
                    <div data-kt-stepper-element="content">
                        <FilePgStep4 :blank-options="blankOptions"
                                     :file-data="fileData"
                                     ...
                                     @generateQuotation="onGenerateQuotation"></FilePgStep4>
                    </div>
                    <!--end::Step 4-->

                    <!--begin::Step 5-->
                    <div data-kt-stepper-element="content">
                        <FilePgStep5 :lists="lists" @generateWorksheet="onGenerateWorksheet"></FilePgStep5>
                    </div>
                    <!--end::Step 5-->
                                    ...
                                    setup() {
                                        ...
                                        const handleStep = handleSubmit( async ( values ) => {
                                            ...
                                            if ( currentStepIndex.value === 0 ) {
                                                ...
                                                fileData.value          = await validatePgStep3( formData.value );
