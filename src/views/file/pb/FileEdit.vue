        ...
        <div class="card-body">
            ...
            >
                ...
                >
                    ...
                    <!--begin::Step 4-->
                    <div data-kt-stepper-element="content">
                        <FilePbStep4 :blank-options="blankOptions"
                                     :file-data="fileData"
                                     ...
                                     @generateQuotation="onGenerateQuotation"></FilePbStep4>
                    </div>
                    <!--end::Step 4-->

                    <!--begin::Step 5-->
                    <div data-kt-stepper-element="content">
                        <FilePbStep5 :lists="lists" @generateWorksheet="onGenerateWorksheet"></FilePbStep5>
                    </div>
                    <!--end::Step 5-->
