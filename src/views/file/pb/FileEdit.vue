    ...
    <div class="card-body">
      ...
      >
        ...
        >
          ...
          <!--begin::Step 4-->
          <div data-kt-stepper-element="content">
            <FilePbStep4 @generateQuotation="onGenerateQuotation"
                         ...
                         :file-data="fileData"
                         :products="products"></FilePbStep4>
          </div>
          <!--end::Step 4-->

          <!--begin::Step 5-->
          <div data-kt-stepper-element="content">
            <FilePbStep5 @generateWorksheet="onGenerateWorksheet" :lists="lists"></FilePbStep5>
          </div>
          <!--end::Step 5-->
...
import { getCurrentPbFileData, resetCurrentFileData } from '@/services/data/dataService';
...
import FilePbStep4 from '@/views/file/pb/FilePbStep4.vue';
import FilePbStep5 from '@/views/file/pb/FilePbStep5.vue';
import { PbFileStep } from '@/types/v2/Wizzard/FileStep';
import { initPbFormDataStep3, validatePbStep3, yupPbConfigStep3 } from '@/services/file/wizzard/pb/step3Service';
import { initPbFormDataStep4, validatePbStep4, yupPbConfigStep4 } from '@/services/file/wizzard/pb/step4Service';
import { initPbFormDataStep5, savePbWorksheet, yupPbConfigStep5 } from '@/services/file/wizzard/pb/step5Service';
...
export default defineComponent( {
                                  ...
                                  setup() {
                                    ...
                                    const fileData            = ref<PbFile>( getCurrentPbFileData() );
                                    ...
                                    const formData            = ref<PbFileStep>( {
                                                                                   ...initFormDataStep1And2( fileData.value.assents,
                                                                                                             fileData.value.beneficiary ),
                                                                                   ...initPbFormDataStep3( fileData.value ),
                                                                                   ...initPbFormDataStep4( fileData.value ),
                                                                                   ...initPbFormDataStep5( fileData.value.worksheet ),
                                                                                 } );
                                    ...
                                    const {
                                            resetForm,
                                            handleSubmit,
                                          }               = useForm<Step1 | Step2 | BaseStep3 | BaseStep4 | PbStep5>(
                                        {
                                    ...
                                    const handleStep = handleSubmit( async ( values ) => {
                                      ...
                                      if ( currentStepIndex.value === 0 ) {
                                        ...
                                        console.log( '%c Validation de l\'étape 1',
                                                     'background: #FF7CA7; color: #000000' );
                                        fileData.value = ( await validateStepTwo( formData.value ) as PbFile );
                                      } else if ( currentStepIndex.value === 2 ) {
                                        console.log( '%c Validation step 3', 'background: #fdd835; color: #000000' );
                                        fileData.value          = await validatePbStep3( formData.value );
                                        ...
                                        await validatePbStep4( formData.value, price );
                                      }
                                    ...
                                    const onGenerateQuotation = handleSubmit( async ( values ) => {
                                      ...
                                      const newFileData     = await validatePbStep4( ( values as PbFileStep ),
                                                                                     price );
                                      // Loader
                                    ...
                                    const onGenerateWorksheet = handleSubmit( async ( values ) => {
                                      ...
                                      const newFileData: PbFile  = savePbWorksheet( ( values as PbFileStep ) );
