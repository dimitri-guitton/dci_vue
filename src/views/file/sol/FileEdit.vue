        ...
        <div class="card-body">
            ...
            >
                ...
                >
                    ...
                    <!--begin::Step 4-->
                    <div data-kt-stepper-element="content">
                        <FileSolStep4 @generateQuotation="onGenerateQuotation"
                                      ...
                                      :file-data="fileData"
                                      :quantity-area="+area"
                                      :products="products"></FileSolStep4>
                    </div>
                    <!--end::Step 4-->

                    <!--begin::Step 5-->
                    <div data-kt-stepper-element="content">
                        <FileSolStep5 @generateWorksheet="onGenerateWorksheet" :lists="lists"></FileSolStep5>
                    </div>
                    <!--end::Step 5-->
                                    ...
                                    setup() {
                                        ...
                                        const handleStep = handleSubmit( async ( values ) => {
                                            ...
                                            if ( currentStepIndex.value === 0 ) {
                                                ...
                                                console.log( '%c Validation step 3',
                                                ...
                                                console.log( '%c Validation step 4',
                                                             'background: #fdd835; color: #000000' );
                                        ...
                                        const onGenerateQuotation = handleSubmit( async ( values ) => {
                                            console.log( '%c ONgenerateQuotation',
                                        ...
                                        const onGenerateWorksheet = handleSubmit( async ( values ) => {
                                            console.log( '%c ON GENERATE Worksheet',
                                                         'background: #00FFCD; color: #000000' );
                                            console.log( values );
                                            ...
                                            const worksheetGenerator   = await WorksheetGenerator.initialize(
                                                newFileData );
