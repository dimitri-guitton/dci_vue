        ...
        <div class="card-body">
            ...
            >
                ...
                >
                    ...
                    <!--begin::Step 4-->
                    <div data-kt-stepper-element="content">
                        <FileCombleStep4 :blank-options="blankOptions"
                                         :file-data="fileData"
                                         ...
                                         @generateQuotation="onGenerateQuotation"></FileCombleStep4>
                    </div>
                    <!--end::Step 4-->

                    <!--begin::Step 5-->
                    <div data-kt-stepper-element="content">
                        <FileCombleStep5 :lists="lists" @generateWorksheet="onGenerateWorksheet"></FileCombleStep5>
                    </div>
                    <!--end::Step 5-->
                                    ...
                                    setup() {
                                        ...
                                        const handleStep = handleSubmit( async ( values ) => {
                                            ...
                                            if ( currentStepIndex.value === 0 ) {
                                                ...
                                                fileData.value          = await validateCombleStep3( formData.value );
