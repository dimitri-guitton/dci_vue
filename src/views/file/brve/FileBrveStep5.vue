...
import { brveWorksheetBuilder } from '@/services/file/wizzard/brve/step5Service';

export default defineComponent( {
                                    name:       'file-brve-step-5',
                                    components: {
                                        Step5Form,
                                    },
                                    props:      {
                                        lists: Object as () => BaseList,
                                    },
                                    ...
                                    setup( props, ctx ) {
                                        ...
                                        return {
                                            worksheetBuilder: brveWorksheetBuilder(),
                                            generateWorksheet,
                                        };
                                    },
                                } );
