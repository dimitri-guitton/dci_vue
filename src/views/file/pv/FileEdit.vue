    ...
    <div class="card-body">
      ...
      >
        ...
        >
          ...
          <!--begin::Step 4-->
          <div data-kt-stepper-element="content">
            <FilePvStep4 @generateQuotation="onGenerateQuotation"
...
export default defineComponent( {
                                  ...
                                  setup() {
                                    ...
                                    const fileData            = getCurrentPvFileData();
                                    ...
                                    const formData            = ref<PvFileStep>( {
                                                                                   ...
                                                                                   ...initPvFormDataStep3( fileData ),
                                                                                   ...initPvFormDataStep4( fileData ),
                                                                                   ...initPvFormDataStep5( fileData.worksheet ),
                                                                                 } );
