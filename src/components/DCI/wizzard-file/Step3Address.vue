<template>
    ...
    <div class="row mb-10">
        ...
        <div class="col-md-6 offset-md-1">
            ...
            <div class="row mb-5">
                <div class="col-md-5 fv-row">
                    <label class="form-label mb-3">Longitude</label>
                    <Field
                        :disabled="true"
                        class="form-control"
                        name="address.position.x"
                        placeholder="0"
                        v-model="geoportail.position.x"
                    />
                </div>
                <div class="col-md-5 fv-row">
                    <label class="form-label mb-3">Latitude</label>
                    <Field
                        :disabled="true"
                        class="form-control"
                        name="address.position.y"
                        placeholder="0"
                        v-model="geoportail.position.y"
                    />
                </div>
            </div>
        </div>
...
export default defineComponent( {
                                    ...
                                    setup( props ) {
                                        ...
                                        if ( geoportail.value.position === undefined ) {
                                            geoportail.value.position = { x: 0, y: 0 };
                                        }
                                        /**
