                ...
                <tr v-for="data in filterData" v-bind:key="data.reference">
                    ...
                    <td>
                        <template v-if="data.errors.length > 0">
                            ...
                            >
                                <template #reference>
                                    <span :class="`badge badge-light-${data.status.class} cursor-pointer`">{{
                                            data.status.name
                                                                                                           }}</span>
                                </template>
                                <template #default>
                                            ...
                                            <li class="d-flex align-items-center py-2">
                                                ...
                                                >
                                                    ...
                                                    <label class="form-check-label"
                                                           :for="`todo_checkbox_${todo.serverId}`">{{ todo.label }}
                                                                                                   {{ todo.isDone }} {{
                                                            todo.isDone ?
                                                            'checked' :
                                                            ''
                        ...
                        <el-dropdown trigger="click" size="large" @command="handleAction">
                            ...
                            <template #dropdown>
                                <el-dropdown-menu>
                                    ...
                                    <el-dropdown-item :command="{type:'open', folder: data}">
                                        <i class="fas fa-folder-open me-2"></i>Ouvrir
                                                                               le
                                                                               répertoire
                                    </el-dropdown-item>
                                    <el-dropdown-item :command="{type:'remove_dci', folder: data}">
                                        <i class="fas fa-trash me-2"></i>Suppression
                                                                         DCI
                                    </el-dropdown-item>
                                    <el-dropdown-item :command="{type:'remove_all', folder: data}">
                                        <i class="fas fa-trash me-2"></i>Suppression
                                                                         Dropbox
                                                                         + DCI
                                    </el-dropdown-item>
                                    <el-dropdown-item :command="{type:'send', folder: data}"
