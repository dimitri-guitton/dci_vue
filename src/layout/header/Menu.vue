<template>
    ...
    >
        <!--begin::Menu-->
        <div
            class="menu menu-rounded menu-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch"
            id="#kt_header_menu"
            data-kt-menu="true"
        >
                ...
                >
                  ...
                  <span class="menu-icon">
                    <span class="svg-icon svg-icon-2">
                      <inline-svg
                          src="media/icons/duotone/Layout/Layout-arrange.svg"
                      />
                    </span>
                  </span>
                                    <span class="menu-title">{{
